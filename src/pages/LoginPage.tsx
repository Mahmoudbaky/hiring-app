...
export function LoginPage() {
  ...
  return (
    ...
    >
      {/* ── Left dark panel ──────────────────────────────────────── */}
      <div className="relative hidden overflow-hidden bg-[#150f28] text-white lg:block">
        <div
          className="absolute inset-0"
          style={{
            background:
              "radial-gradient(120% 80% at 0% 100%, rgba(107,71,245,0.55), transparent 60%), radial-gradient(80% 60% at 100% 0%, rgba(137,108,247,0.35), transparent 55%)",
          }}
        />
        <div
        ...
        <div className="relative flex h-full flex-col p-12">
          ...
          <div className="flex max-w-[480px] flex-1 flex-col justify-center">
            ...
            <h1 className="text-[42px] leading-[1.15] font-bold tracking-tight text-balance">
              أدر طلبات التوظيف
              <br />
              من <span className="text-[#a894fa]">مكان واحد</span>.
            </h1>
